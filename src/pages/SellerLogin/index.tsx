...
const SellerLogin = () => {
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center bg-gradient-to-r from-red-700 to-yellow-500">
            <div className="w-[30%] h-full flex-col flex justify-center items-center bg-200-main">
                ...
                <h2 className="text-[24px] text-100-main font-domine text-center font-semibold">-Seller-</h2>
