                            ...
                            <div className="w-[30%] p-4">
                                <div className="bg-main-400 p-2 rounded-md">
                                    ...
                                    <div className="flex justify-center">
                                        <button className="bg-main-300 text-white font-semibold font-domine text-[22px] rounded-md p-2 m-2" onClick={() => store.setProductDetails([...store.getProductDetails(), {id: "1",name: "Product 1", price: 100}])}>Add to cart</button>
                                    </div>
                                </div>
                            </div>
                            <div className="w-[30%] p-4">
                                <div className="bg-main-400 p-2 rounded-md">
                                    ...
                                    <div className="flex justify-center">
                                        <button className="bg-main-300 text-white font-semibold font-domine text-[22px] rounded-md p-2 m-2" onClick={() => store.setProductDetails([...store.getProductDetails(), {id: "2",name: "Product 2", price: 30}])}>Add to cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
