...
const Checkout = () => {
    ...
    return (
        <div className="flex flex-col my-[50px]">
            <h1 className="font-domine text-[22px] text-black font-semibold text-center my-[10px] w-full">Checkout</h1>
            <div className="bg-main-500 p-2 rounded-md w-fit mx-auto">
            ...
            {userWallet.balance < totalPrice ? (
                <h1 className="font-domine text-[22px] text-black font-semibold text-center my-[10px] w-full">Insufficient Balance</h1>
            ) : (
                <>
                    <h1 className="font-domine text-[22px] text-100-main font-semibold text-center my-[10px] w-full">Sufficient Balance</h1>
                    <Link to="/pay" id="pay" className="bg-main-500 p-2 mx-auto rounded-md w-fit text-center text-white font-domine font-semibold">Pay</Link>
                </>
            )}
        </div>
    )
