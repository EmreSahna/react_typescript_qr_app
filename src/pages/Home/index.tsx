const Home = () => {
    return (
        <div className="">
            <div className="w-full py-40 bg-gradient-to-b from-main-500 via-[#424ef3] to-main-500">
                <div className="container mx-auto flex justify-center">
                    <div className="flex flex-col justify-center w-[40%]">
                        ...
                        <p className="text-white font-roboto text-[20px]">Streamline Your Payment Process with QuickPayr</p>
                    </div>
