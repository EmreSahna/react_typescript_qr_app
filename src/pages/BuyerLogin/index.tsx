...
const BuyerLogin = () => {
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center bg-gradient-to-r from-main-300 to-main-600">
            <div className="w-[30%] h-full flex-col flex justify-center items-center bg-white">
                ...
                <h2 className="text-[24px] text-main-200 font-domine text-center font-semibold">-Buyer-</h2>
                <div className="inline-flex mt-[20px]">
                    <div id="signin" onClick={() => setFormType("signin")} className="p-[10px] rounded-md cursor-pointer">
                        <div className="text-[24px] text-black font-domine font-semibold text-center">
                            Sign In
                        </div>
                    </div>
                    <div id="signup" onClick={() => setFormType("signup")} className="p-[10px] rounded-md cursor-pointer">
                        <div className="text-[24px] text-black font-domine font-semibold text-center">
                            Sign Up
                        </div>
                    </div>
                ...
                {formType === "signin" ? (   
                    <form onSubmit={handleSignIn(signin)} className="w-[80%]">
                        ...
                        <button className="flex mx-auto">
                            <div className="flex flex-row items-center justify-center mt-[20px] text-white bg-gradient-to-r from-main-300 to-main-600 shadow-md py-2 px-4 rounded-md gap-[4px]">
                    ...
                    <form onSubmit={handleSignUp(signup)} className="w-[80%]">
                        ...
                        <button className="flex mx-auto">
                            <div className="flex flex-row items-center justify-center mt-[20px] text-white shadow-md bg-gradient-to-r from-main-300 to-main-600 py-2 px-4 rounded-md gap-[4px]">
